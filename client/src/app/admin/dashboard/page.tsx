...
export default function AdminDashboard() {
    ...
    useEffect(() => {
        const checkAuthAndFetch = async () => {
            ...
            // Fetch ALL Deals (admin sees everything)
    ...
    return (
        <ProtectedRoute>
            <div className="h-full flex flex-col overflow-hidden bg-slate-100">
                {/* Header Stats */}
                <header className="flex-none bg-gradient-to-r from-purple-600 to-purple-700 border-b border-purple-800 px-6 py-4 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-sm text-purple-100 mt-1">Manage all deals across the organization</p>
                    </div>
                    <div className="flex gap-6">
                        <div className="text-right">
                            <div className="text-sm text-purple-200">Total Pipeline</div>
                            <div className="text-xl font-bold text-white">
                                ${stats?.total_pipeline_value ? Number(stats.total_pipeline_value).toLocaleString() : '0.00'}
                            </div>
                        </div>
                        <div className="text-right">
                            <div className="text-sm text-purple-200">Weighted Forecast</div>
